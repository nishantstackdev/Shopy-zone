...
const { createproduct, getProduct, getProductById, deleteProduct, updateProduct, editbrand, add_images } = require("../controllers/productcontroller.js")
...
ProductRuter.post("/other-images/:id",add_images)
